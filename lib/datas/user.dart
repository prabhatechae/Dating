...
class User {
  ...
  final String userDropDownList;
  final String userFaceRecognition;
  ...
  User({
    ...
    required this.userDropDownList,
    required this.userFaceRecognition,
  ...
  factory User.fromDocument(Map<String, dynamic> doc) {
    return User(
      ...
      userVideoUrl: doc[USER_VIDEO_LINK].toString(),
      userDropDownList: doc[USER_DROPDOWN_LIST].toString(),
      userFaceRecognition: doc[USER_FACE_RECOGNITION].toString(),
