...
class _PhoneNumberScreenState extends State<PhoneNumberScreen> {
  ...
  final List<String> _initialSelection = ['AE', 'Us']; // Default country codes for the United States and the United Arab Emirates (Dubai)
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Padding(
                            ...
                            child: CountryCodePicker(
                                alignLeft: false,
                                initialSelection: 'AE', //_initialSelection.toString(),
                                onChanged: (country) {
                                  /// Get country code
