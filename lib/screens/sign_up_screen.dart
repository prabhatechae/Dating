                  ...
                  children: <Widget>[
                    ...
                    Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color:
                                Colors.white), // Add white color to the border
                      ),
                      child: DropdownButtonFormField<String>(
                        ...
                        hint: Text(
                          ...
                          style: const TextStyle(
                              color:
                                  Colors.white), // Add white color to hint text
                        ),
                        onChanged: (gender) {
                          setState(() {
          ...
          Checkbox(
            ...
            fillColor: MaterialStateColor.resolveWith((states) {
              if (states.contains(MaterialState.selected)) {
                ...
                return Colors
                    .white; // Change this to the desired color for the checkbox border
              } else {
            ...
            visualDensity: VisualDensity
                .compact, // Add this property to make the checkbox visible
            value: _agreeTerms,
            onChanged: (value) {
